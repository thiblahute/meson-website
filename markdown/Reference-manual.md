...
This page lists functions and methods available in Meson scripts. For more in-depth documentation on how to use them, refer to the [manual](Manual.md). For more basic information about how Meson works, take a look at the [syntax reference](Syntax.md).
